...
class Student
{
    ...
    string fullGender, status, am_pm;
...
void Student::getData()
{
    ...
    {    cout << Color(4) << Bold("\nYour Marks are exceed it's limit. Please Enter Your Marks Again...! (Under 100 or Maximum 100)\n\n"); goto Marks;     }
    ...
    if (ltm->tm_hour >= 12 && ltm->tm_min >= 0)
    {
       am_pm = "PM";
    }
    else
...
void Student::modifyData()
{
    ...
    cout << "\nYour Application Number is : " << Color(6) << admno << endl;
    cout << Color(2) << Bold("\nYour Application is successfully modified with new detailes..!\n");
}
...
void Student::showData()
{
    ...
    cout<<"\t  Time                         : "<< hr << ":" << min << ":" << sec << " " << am_pm << endl;
    cout << Color(15) << Bold("\t       -------------------------------------\n");
...
void modifyData()
{
    ...
    while(fio.read((char*)&s,sizeof(s)))
    {
        ...
        if(n == s.getAdmno())
        {
            cout<< endl << endl <<"Following Application No. "<< n <<" will be Changed:\n";
            s.showData();
